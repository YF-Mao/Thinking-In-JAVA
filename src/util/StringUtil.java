...
public class StringUtil {
    public static final TimeZone TZ_GMT8 = TimeZone.getTimeZone(Constants.DEFAULT_DATE_TIMEZONE);
     ...
     * @return
     */
    public static boolean equals(Object map, Object key) {
        boolean res = true;
        if (map == null && key != null) {
            res = false;
        } else if (map != null && key == null) {
            res = false;
        } else if (map == null && key == null) {
            res = true;
        } else if (!map.toString().equals(key.toString())) {
            res = false;
        }
        return res;
    }
...
//		s = Replace(s, " ", "&nbsp;");
    ...
    public static String formatDateTime(Date date) {
        ...
        dateFormat.setTimeZone(TZ_GMT8);
